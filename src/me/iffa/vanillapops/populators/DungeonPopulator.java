...
public class DungeonPopulator extends BlockPopulator {
    /**
     * Populates a chunk with a dungeon.
     * 
     * @param world World
     * @param random Random
    ...
    /**
     * Picks a random stone: cobble or mossy cobble.
     * 
     * @param random Random
     * 
     * @return Random stone as Material
     */
    private static Material pickStone(Random random) {
        return random.nextInt(6) == 0 ? Material.MOSSY_COBBLESTONE
                : Material.COBBLESTONE;
    }

    /**
     * Places a creature spawner.
     * 
     * @param random Random
     * @param block Block
     */
     ...
     * @param random Random
     * 
     * @return Random ore as ItemStack
     */
     ...
     * @param index Index
     * 
     * @return Random tool as ItemStack
     */
     ...
     * @param index Index
     * 
     * @return Random armor as ItemStack
     */
    ...
    /**
     * Checks if a block can be placed.
     * 
     * @param world World
     * @param x X-position
     * @param y Y-position
     * @param z Z-position
     * 
     * @return True if a block can be placed at the location 
     */
